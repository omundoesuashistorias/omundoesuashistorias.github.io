...
🔗 **Website:** [omundoesuashistorias.github.io](https://omundoesuashistorias.github.io)
🌐 **Página alternativa (com acento):** [omundoesuashistórias.github.io](https://omundoesuashistórias.github.io)
...
O projeto **O Mundo e Suas Histórias** é composto por vários repositórios complementares:

### 1. **omundoesuashistorias.github.io** (Principal)
- **ID:** 1002136387
- **Composição de linguagens:**
  - HTML: 88.2%
  - CSS: 6.3%
  - JavaScript: 5.5%
- **Descrição:** Repositório principal com o site institucional, página inicial, listagem de episódios e recursos públicos.
...
- **Composição de linguagens:**
  ...
  - CSS: 2.2%
  - JavaScript: 0.3%
- **Descrição:** Repositório dedicado a conteúdo de posts e artigos, com estrutura otimizada para publicação de matérias.
...
- **Composição de linguagens:**
  - HTML: 56%
  - CSS: 44%
- **Descrição:** Repositório temático focado em conteúdos relacionados a filosofia e reflexões culturais.
...
- **Composição de linguagens:**
  ...
  - HTML: 44.1%
  - JavaScript: 9.3%
- **Descrição:** Repositório destinado a testes, experimentos e prototipagem de novas funcionalidades.

### 5. **adtrologia**
- **ID:** 1154789625
- **Composição de linguagens:**
  - HTML: 100%
- **Descrição:** Repositório especializado em conteúdo relacionado a astrologia e temas correlatos.
